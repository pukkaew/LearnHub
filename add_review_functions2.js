...
// Find the exact pattern with newlines
const oldPattern = `    \`).join('');
}
...
if (content.includes(oldPattern)) {
    ...
    if (content.includes(simplePattern)) {
        console.log('Found simpler pattern, trying that...');
...
`;
        ...
        fs.writeFileSync(filePath, content, 'utf8');
        console.log('✅ Added review functions using simpler pattern');
    }
}
